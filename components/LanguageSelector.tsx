...
const LanguageSelector = () => {
  ...
  const { currentLang, isTranslating, progress, setLanguage } = useTranslation()
      ...
      <Menu as="div" className="relative inline-block text-left">
        <div className="text-muted flex items-center justify-center">
          <MenuButton
            ...
            className="hover:text-ink dark:hover:text-paper inline-flex h-9 min-w-9 items-center justify-center rounded-full px-2 text-base leading-none transition-colors"
                ...
                <MenuItem key={lang.code}>
                  {({ focus }) => (
                    <button
                      ...
                      className={`${focus ? 'text-ink dark:text-paper bg-gray-200 dark:bg-gray-700' : 'text-muted'} ${
